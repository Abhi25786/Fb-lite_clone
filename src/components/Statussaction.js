            ...
            <View >
                <View style={styling.border}>
                    <View style={{ justifyContent: "center", alignItems: "center" }} >
                        <TouchableOpacity><Image source={require('../assets/Images/profile_user.jpg')} style={styling.profilepic} /></TouchableOpacity>
                    ...
                    <View style={styling.picuplode}>
                        <TouchableOpacity><Image source={require('../assets/Images/uplode.png')} style={styling.home} /></TouchableOpacity>
